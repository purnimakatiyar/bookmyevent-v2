...
class TestMenu:
    ...
    def test_start_view(self, setup, monkeypatch, user_input):
        ...
        monkeypatch.setattr("src.helpers.menu.constants", constants)
        monkeypatch.setattr("src.helpers.menu.prompts", prompts)
        monkeypatch.setattr("src.helpers.menu.menu", menu)
